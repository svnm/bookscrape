	  ...
	  _createClass(Book, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      for (var i = 0; i < _books2['default'].length; i++) {
	        if (_books2['default'][i].title == this.props.params.title) {
	          book = _books2['default'][i];
	        }
	      }

	      var url = 'http://127.0.0.1:5000/api/books?';
	      url += 'isbn=' + book.isbn;
	...
	var Home = (function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function render() {
	      ...
	      var previewList = this.state.books.map(function (b, i) {

	        return _react2['default'].createElement(_Preview2['default'], { title: b.title, isbn: b.isbn, author: b.author });
	      });
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            Link,
	            { to: 'book', params: { title: this.props.title } },
	            _react2['default'].createElement(
	              'h4',
	              { className: 'title' },
	              this.props.title
